  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-slate-950 pt-24">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="h-full w-full bg-[linear-gradient(rgba(255,255,255,0.2)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.2)_1px,transparent_1px)] bg-[size:50px_50px]"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="mt-6 text-lg text-slate-300 max-w-xl">
            Hire8 Global Staffing Services helps businesses recruit
            high-performing professionals through innovative hiring
            strategies, talent sourcing, and workforce solutions.
          </p>
        ...
        >
          ...
          {/* Floating Card */}
          <div className="absolute -top-6 -left-6 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-4 text-white shadow-xl">
          ...
          {/* Floating Card */}
          <div className="absolute -bottom-6 -right-6 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-4 text-white shadow-xl">
            <h4 className="font-semibold">
              IT & Non-IT Hiring
            </h4>
            <p className="text-sm text-slate-300">
